// To parse this data:
//
//   import { Convert, PokeapiResponseInterface } from "./file";
//
...
export class Convert {
	public static toPokeAPIResponse(json: string): PokeApiResponse {
		return cast(JSON.parse(json), r("PokeapiResponseInterface"));
	}
	
	public static pokeAPIResponseToJson(value: PokeApiResponse): string {
		return JSON.stringify(uncast(value, r("PokeapiResponseInterface")), null, 2);
	}
}
